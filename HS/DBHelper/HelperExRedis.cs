...
namespace HS
{
    ...
    public class RedisHelper
    {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public string StringGet<T>(string key)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<string> StringGetAsync<T>(string key)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="dataKey"></param>
        /// <returns></returns>
        public string HashGet<T>(string key, string dataKey)
        {
            key = AddSysCustomKey(key);
            return Do(db =>
            {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public List<string> HashKeys<T>(string key)
        {
            key = AddSysCustomKey(key);
            return Do(db =>
            {
        ...
        /// <param name="dataKey"></param>
        /// <returns></returns>
        public async Task<string> HashGeAsync<T>(string key, string dataKey)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public List<string> ListRange<T>(string key)
        {
            key = AddSysCustomKey(key);
            return Do(redis =>
            {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public string ListRightPop<T>(string key)
        {
            key = AddSysCustomKey(key);
            return Do(db =>
            {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public string ListLeftPop<T>(string key)
        {
            key = AddSysCustomKey(key);
            return Do(db =>
            {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<List<string>> ListRangeAsync<T>(string key)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<string> ListRightPopAsync<T>(string key)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<string> ListLeftPopAsync<T>(string key)
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public List<string> SortedSetRangeByRank<T>(string key)
        {
            key = AddSysCustomKey(key);
            return Do(redis =>
            {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<List<string>> SortedSetRangeByRankAsync<T>(string key)
        {
            key = AddSysCustomKey(key);
        ...
        {
            string result = value.ToString();//value.ToString();//value is string ? value.ToString() : JsonConvert.SerializeObject(value);
            return result;
        }

        private string ConvertObj<T>(RedisValue value)
        {
            return value.ToString();//JsonConvert.DeserializeObject<T>(value);
        }

        private List<string> ConvetList<T>(RedisValue[] values)
        {
